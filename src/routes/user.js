...
Route
    ...
    .post('/login/step2', [check('securityCode').isNumeric().isLength({ min:6,max:6 })], userController.login2)
    ...
    .post('/signup/step2', [check('securityCode').isNumeric().isLength({ min:6,max:6 })], userController.signup2);
